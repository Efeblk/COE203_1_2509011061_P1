...
from folder_utils import organize_files_in_destination, CATEGORIES
...
def test_copy_files(test_dirs):
    ...
    organize_files_in_destination(source_dir, dest_dir, same_place=False)
...
def test_move_files(test_dirs):
    ...
    organize_files_in_destination(source_dir, source_dir, same_place=True)
...
def test_categories_loaded():
    """
    Tests that the mocked categories are loaded.
    """
